...
R package **magpiesets**, version **0.40.10**
...
_magpiesets: MAgPIE sets for R_. doi: 10.5281/zenodo.1158588 (URL: https://doi.org/10.5281/zenodo.1158588),
R package version 0.40.10, <URL: https://github.com/pik-piam/magpiesets>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 0.40.10},
