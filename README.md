...
R package **magpiesets**, version **0.44.2**
...
Bodirsky B, Humpenoeder F, Mishra A, Karstens K, Weindl I, Molina Bacca E, von Jeetze P, Dietrich J (2021). _magpiesets: MAgPIE sets for R_. doi: 10.5281/zenodo.1158588 (URL: https://doi.org/10.5281/zenodo.1158588), R package version 0.44.2, <URL: https://github.com/pik-piam/magpiesets>.
